...
int main(int argc, char **argv)
{
	...
	while(!exit_loop)
	{
		...
		// cv::Mat closing_and_opening_img(input_img.rows-8, input_img.cols-8, CV_8UC1);		
		// opening(closing_img, structural_element, closing_and_opening_img);
		/////////////////////
		...
		// cv::namedWindow("closing_and_opening_img", cv::WINDOW_NORMAL);
		// cv::imshow("closing_and_opening_img", closing_and_opening_img);
