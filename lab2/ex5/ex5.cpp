/**
 * Caricate l'immagine di Lenna e fate un flip orizzontale:
 * creare una nuova immagine di dimensioni w e h ottenuta invertendo l'ordine delle colonne dell'imm originale
 */
//OpenCV
