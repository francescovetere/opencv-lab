/**
 * Caricate l'immagine di Lenna e fate un downsample 2x:
 * una nuova immagine di dimensioni w/2 e h/2 ottenuta prendendo una riga si ed una no, una colonna si ed una no
 */
//OpenCV
